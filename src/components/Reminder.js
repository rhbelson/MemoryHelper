...
class Reminder extends Component {
  render() {
    return (
        <Row style = {{fontFamily:"Karla", fontWeight:"bold", color: '#010423', paddingLeft: '5px',marginBottom: '5px', borderRadius: '40px',  width: '100%', alignItems: 'center', backgroundColor: '#b1b7fc'}}>
